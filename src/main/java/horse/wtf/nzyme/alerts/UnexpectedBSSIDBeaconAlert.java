...
public class UnexpectedBSSIDBeaconAlert extends Alert {
    ...
    public static UnexpectedBSSIDBeaconAlert create(@NotNull String ssid, String bssid, int channel, int frequency, int antennaSignal, long frameCount) {
        ...
        return new UnexpectedBSSIDBeaconAlert(DateTime.now(), Subsystem.DOT_11, fields.build(), frameCount);
    }
