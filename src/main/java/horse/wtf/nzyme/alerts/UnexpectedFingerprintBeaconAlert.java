...
public class UnexpectedFingerprintBeaconAlert extends Alert {
    ...
    public static UnexpectedFingerprintBeaconAlert create(@NotNull String ssid, String fingerprint, String bssid, int channel, int frequency, int antennaSignal, long frameCount) {
        ...
        return new UnexpectedFingerprintBeaconAlert(DateTime.now(), Subsystem.DOT_11, fields.build(), frameCount);
    }
